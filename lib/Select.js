...
var stringOrNode = _propTypes2.default.oneOfType([
	_propTypes2.default.string,
	_propTypes2.default.node
]);
var stringOrNumber = _propTypes2.default.oneOfType([
	_propTypes2.default.string,
...
var shouldShowPlaceholder = function shouldShowPlaceholder(
	state,
	props,
	isOpen
) {
	...
	_createClass(Select, [
		...
		},
		{
			...
			value: function selectValue(value) {
				...
				var updatedValue = this.props.onSelectResetsInput
					? ''
					: this.state.inputValue;
				if (this.props.multi) {
					this.setState(
						...
						function() {
							...
							if (
								valueArray.some(function(i) {
									return (
										i[_this3.props.valueKey] === value[_this3.props.valueKey]
									);
								})
							) {
		...
		},
		{
			...
			value: function renderValue(valueArray, isOpen) {
				...
				if (!valueArray.length) {
					var showPlaceholder = shouldShowPlaceholder(
						this.state,
						this.props,
						isOpen
					);
				...
				if (this.props.multi) {
					return valueArray.map(function(value, i) {
						return _react2.default.createElement(
							...
							{
								disabled:
									_this5.props.disabled || value.clearableValue === false,
		...
		},
		{
			...
			value: function renderInput(valueArray, focusedOptionIndex) {
				...
				if (this.props.disabled || !this.props.searchable) {
					...
					var _ariaOwns = (0, _classnames2.default)(
						_defineProperty({}, this._instancePrefix + '-list', isOpen)
					);
					return _react2.default.createElement(
						'div',
						_extends({}, divProps, {
				...
				if (this.props.autosize) {
					return _react2.default.createElement(
						...
						_extends({ id: this.props.id }, inputProps, { minWidth: '5' })
					);
				}
				return _react2.default.createElement(
					'div',
					...
					_react2.default.createElement(
						'input',
						_extends({ id: this.props.id }, inputProps)
					)
				);
			}
		},
		{
			...
			value: function renderClear() {
				...
				if (
					...
					return;
				var ariaLabel = this.props.multi
				...
				if (this.props.filterOptions) {
					...
					var filterOptions =
						typeof this.props.filterOptions === 'function'
							...
							: _defaultFilterOptions2.default;
